                  ...
                  <div className='row align-items-center'>
                    <div className="col-lg-6">
                      <div className='project_img'>
                        <div className="project_img_color"></div>
                          <img src="/img/leadster.png" className='img-fluid' alt="" />
                        
                      </div>
                    </div>
                    <div className="col-lg-6 position-relative">
                      <p className='text_pink f_600 f_size_16'>Featured Project</p>
                      <h2 className='text_white f_size_24em'>Leadster Website</h2>
                      <div className='box_project_description'>
